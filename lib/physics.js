...
class Physics {
    ...
    #resolveCollisions() {
        ...
        for (let node of this.#nodes) {
            this.#checkCollisionWithBoundary(node);
    ...
    #resolveCollisionNodeConnection(node, connection) {
        ...
        const avgBounciness = (node.bounciness + connection.node1.bounciness + connection.node2.bounciness) / 3;
        const responseCoef = this.#responseCoef; 
        overlap *= (1 + avgBounciness) * responseCoef;
     ...
     * @private
     */
    #checkCollisionWithBoundary(node) {
