class Camera {
     ...
     * 
     * @param {boolean} autoWaitForCanvas - If true, the method will keep checking for the presence of the canvas in the DOM.
    ...
    init(autoWaitForCanvas = false) {
        ...
        // If canvas isn't present yet and autoWait is true, set up a MutationObserver.
