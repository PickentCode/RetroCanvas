class Camera {
     ...
     */
    drawAnimationFrame(frame, position, width, height, angle = 0) {
        ...
        this.drawImage(frame.image, position, width, height, angle, new Vector(frame.srcX, frame.srcY), frame.width, frame.height);
    }
