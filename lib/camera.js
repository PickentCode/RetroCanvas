class Camera {
     ...
     */
    constructor(gameWidth, gameHeight, canvasWidth, canvasHeight, fpsUpdateRate, canvasName, smooth = false) {
    ...
    drawAnimationFrame(frame, position, width, height, angle = 0, reflectX = false, reflectY = false) {
        ...
        this.drawImage(frame.image, position, width, height, angle, new Vector(frame.srcX, frame.srcY), frame.width, frame.height, reflectX = false, reflectY = false);
    }
