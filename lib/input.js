// TO-DO: full mouse input system with buttons, full keyboard input system with getKey, getKeyDown, getKeyUp. Gamepad support
...
class Input {
    ...
    onLeftButtonDown() {
        ...
        console.log("Left mouse button pressed at", this.position);
    }
